...
char uart_buf[50];
int uart_buf_len;
char spi_rx_buf1[11];  // Corregir la declaración
char spi_rx_buf3[11];  // Corregir la declaración

volatile uint8_t spi1_received = 0;
volatile uint8_t spi3_received = 0;
/* USER CODE END PV */
